...
public class ProjetoView extends javax.swing.JFrame {
    ...
    public ProjetoView() {
        initComponents();
        DefaultTableModel modeloTableProjetos = (DefaultTableModel) jTableProjetos.getModel();
    }
    ...
    public void getListaProjetos(){
        DefaultTableModel modeloTableProjetos = (DefaultTableModel) jTableProjetos.getModel();
        modeloTableProjetos.setNumRows(0);
        
        for (Projeto p : projetoController.read()){
        
            modeloTableProjetos.addRow(new Object[]{
            p.getIdprojeto(),
            p.getNome(),
            p.getDatainicio(),
            p.getDataconclusao(),
    ...
    private void initComponents() {
        ...
        jTableProjetos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "IdProjeto", "Nome", "Data de Início", "Data de Conclusão", "Profissional Responsável", "Cliente"
            }
        ) {
